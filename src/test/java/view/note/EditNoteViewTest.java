...
public class EditNoteViewTest {
    @Test
    public void testEditNoteView() throws IOException, ParseException {
        ...
        JPanel editNoteView = new EditNoteView(noteViewModel, viewManagerModel, controller);
        JFrame jf = new JFrame();
        jf.setContentPane(editNoteView);
        jf.pack();
        jf.setVisible(true);
