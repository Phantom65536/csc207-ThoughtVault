...
public class DetailedLocalEventViewTest {
    @Test
    public void testDetailedLocalEventViewTest() throws IOException, ParseException {
        ...
        JPanel DetailedLocalEventView = new DetailedLocalEventView(LocalEventViewModel, localEventController);
